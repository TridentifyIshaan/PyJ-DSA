...
> Purpose: To print a hollow diamond pattern (pyramid + inverse pyramid)
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= n; i++) {
            ...
            for (int k = 1; k <= 2 * i - 1; k++) {
                if (k == 1 || k == 2 * i - 1 || i == 1) { // Here, i == last will be empty
                    System.out.print("* ");
                } else {
                    System.out.print("  ");
                }
        ...
        for (int i = 1; i <= n - 1; i++) { // n - 1 = n - 1
            ...
            for (int k = 1; k <= 2 * (n - i) - 1; k++) { // 2 * (n - i) + 1 - 1 - 1 = 2 * (n - i) - 1
                if (k == 1 || k == 2 * (n - i) - 1 || i == n - 1) { // Here, i == 1 will be empty
                    System.out.print("* ");
                } else {
                    System.out.print("  ");
                }
